    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-300">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden mb-8 border border-gray-200 dark:border-gray-700">
            ...
            <div className="p-8">
              ...
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Descripción</h2>
      ...
      {showVoucherModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full p-10 border border-gray-200 dark:border-gray-700">
            ...
            {uploadSuccess ? (
              <div className="text-center py-6 space-y-6">
                <div className="mx-auto flex items-center justify-center h-20 w-20 rounded-full bg-green-100 dark:bg-green-900/30 text-green-600">
                  <CheckCircle size={48} />
                </div>
                <div className="space-y-2">
                  <h3 className="text-3xl font-bold text-gray-900 dark:text-white">¡Voucher Recibido!</h3>
                  <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                    Tu comprobante ha sido enviado correctamente. El docente lo revisará pronto para darte acceso al curso.
                  </p>
                </div>
                <div className="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-xl border border-blue-100 dark:border-blue-800 max-w-lg mx-auto">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-bold transition-all shadow-md transform hover:scale-105"
                >
                  Entendido, ¡gracias!
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  {(course.teacher_yape_qr || course.teacher_plin_qr) ? (
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      {course.teacher_yape_qr && (
                        <div className="text-center">
                          <p className="text-[10px] font-bold text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wider">Paga con Yape</p>
                      ...
                      {course.teacher_plin_qr && (
                        <div className="text-center">
                          <p className="text-[10px] font-bold text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wider">Paga con Plin</p>
                          <div className="bg-gray-50 dark:bg-gray-900 p-2 rounded-lg border border-gray-100 dark:border-gray-800">
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 p-4 rounded-lg mb-6 text-center">
                ...
                <div className="space-y-6">
                  <a
                    ...
                    className="flex items-center justify-center space-x-2 w-full p-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors font-semibold shadow-sm text-sm"
                  >
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                      <span className="px-2 bg-white dark:bg-gray-800 text-gray-500 font-bold">O sube tu voucher</span>
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleVoucherUpload} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="block w-full text-xs text-gray-900 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 focus:outline-none file:mr-3 file:py-2 file:px-3 file:border-0 file:text-xs file:font-semibold file:bg-primary-600 file:text-white hover:file:bg-primary-700"
                        required
                      />
                    </div>
                    ...
                    <div className="flex space-x-3 pt-2">
                      <button
                        type="submit"
                        disabled={uploading}
                        className="flex-1 btn-primary disabled:opacity-50 flex items-center justify-center space-x-2 py-2.5"
                      >
                        <Upload size={18} />
                        <span className="text-sm">{uploading ? 'Subiendo...' : 'Registrar Pago'}</span>
                      </button>
                      <button
                        type="button"
